...
import { DataCustomersService } from '../../services/data-customers.service'
...
export class AddLibriComponent {
  @Input() libro: Libro = new Libro(); //this.iniLibro();
  @Output() fatto = new EventEmitter<boolean>();

  librofrm: FormGroup;

  constructor(public datiService: DataCustomersService, public fb: FormBuilder) {
